    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-produtos">
                <form action="{{BASE}}admin/deleta/{{produtos.Id}}" onsubmit="return validar(true);" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 text-right">
                            <input type="submit" value="Deletar" class="btn btn-success w-100">
                        </div>
                    </div>
                </form>
            </div>
